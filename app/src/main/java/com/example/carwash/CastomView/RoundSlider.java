package com.example.carwash.CastomView;
...
public class RoundSlider extends View {
    ...
    public static final int START_ANGLE = 205;
    public static final int END_ANGLE = 65 + 270;
    ...
    private void drawTouchSlider(Canvas canvas) {
        ...
        customCenter.y = (int)
                (Math.sin(Math.toRadians(angle)) * roundRadius + center.y + roundRadius);
        paint.setColor(Color.parseColor("#E3E328"));
